...
| ⛔⛔ **gate-passing wins, re-checked a day later - CORRECTED 2026-09-22 from chain** | **8 of 15 are still sellable**, not 5. ⛔ **My morning call of "10 collapsed" was wrong on 3** (ChatGPT $89.44, tradecat $90.07, Vortex $89.47 back on a live $100 Jupiter round trip). ⭐ **And 4 of the 5 dead ones died by a single `Withdraw` as the LAST event on the pool**: USDCAT 09-21 19:54:19Z, OWL 09-22 07:14:06Z, X7 `BsE3…` 10:27:06Z, EMBER 11:09:37Z. TSLA and UOTF unresolved | `data/findings/REPORT_2026-09-22_pushback.md`, `analysis/daily_2026-09-22/pushback/` |
| ⛔⛔ **EMBER was NOT dead this morning** | Its PumpSwap pool `AVW2pYeH…` held **2,690 SOL (~$317k)** at 10:36:32Z. At **11:09:37Z** the creator `HoX8uwcQiEmz…` withdrew **2,907.565 SOL (~$343k)** and burned the LP. **Our 24h check ran 11:12:10Z, 2m33s later.** ⭐ **Our $292k depth at 17:11Z on 09-21 is CONFIRMED by chain** (2,515.2 SOL in the vault at 17:18:01Z): the 3.97x was real and stayed realizable ~18h more. ⛔ Dead NOW ($20.36 across 5 pools on 3 venues, $100 → $0.32) but it died at a timestamp, by a person. ⛔ **Never repeat "all three pools: $2.64"** - that was Dexscreener; and EMBER is a **Meteora DBC** launch, not pump.fun. ⛔⛔ **AND IT IS NOT A MEMECOIN: it is a token-pairing LAUNCHPAD on Meteora**, which round-tripped **$6m → $40m → under $10m on 09-10/09-11**, ten days before our journal first saw it (@CryptoGorilla archive, his claim, dated). ⭐ So the thing that was rugged was **launch infrastructure for the pairing meta itself** | same |
...
| ⛔⛔ **a ticker CANNOT be resolved to a contract after the fact** | The listings stop returning a token once it has no liquidity, so **the dead are invisible and every ticker resolves to a living namesake**. EMBER's real contract `FLCr9vGM…HTsh` appears in **no** search result; the resolver picked a different live EMBER ($2.1m liq) and graded it **HIGH confidence, alive**. ⭐ **Proof it is an artifact: ticker-arm survival is FLAT at 60-69% across every age bucket (incl. 35+ days) while the address-keyed control decays 10→13→3%.** ⛔ **So no hit rate on any ticker-only source may be published**; 202 of 482 rows are `unverifiable` | `docs/GORILLA_ARCHIVE.md` §3 |

...
| ⛔ **venue blindness, measured** | DefiLlama Solana 24h **$3.656B / 125 protocols**: our chain reader parses **46.4%**, is blind to **53.6%** (BisonFi alone **12.2%**, bigger than PumpSwap). pump.fun + PumpSwap = **14.4%**, so the pump-only graduation ledger misses **85.6% by volume**. Jupiter routed today through Quantum, BisonFi, Kipseli, HumidiFi, Scorch, Flux, Quay - none of which we recognise | same |

...
python pooldiscovery.py <MINT>                             # ⭐⭐ find the REAL pools from the mint, on chain
python test_pooldiscovery.py                               # ⭐ 41 checks incl. the two a control caught
